...
class Dashboard_Context extends Base_Context {
	...
	public function init_context() {
		...
		add_action(
			'wp_dashboard_setup',
			array( &$this, 'setup_widgets_callback' )
		);
	}

	public function setup_widgets_callback() {
	...
	public function dashboard_widget_callback() {
		...
		echo "<div class='feature_post_class_wrap'><label style='background:#ccc;'>$output</label></div>";
	}
